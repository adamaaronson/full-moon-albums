...
edge_cases = {
    ...
    ('Los Thuthanaka', 'Los Thuthanaka'): {
        'album_url': 'https://losthuthanaka.bandcamp.com/album/los-thuthanaka-2',
        'image_url': 'losthuthanaka.jpg',
    },
}

non_breaking_strings = (('Vol. ', 'Vol.\u00a0'), ("Brasil '66", "Brasil\u00a0'66"))

client_credentials_manager = SpotifyClientCredentials(
    client_id=apiconfig.CLIENT_ID, client_secret=apiconfig.CLIENT_SECRET
)
    ...
    with open(csv_file) as f:
        ...
        for row in reader:
            ...
            if (artist, album) in albums_in_json:
                ...
                album_url, image_url = (
                    edge_cases[artist, album]['album_url'],
                    edge_cases[artist, album]['image_url'],
                )
            else:
